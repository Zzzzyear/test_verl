...
try:
    ...
    try:
        # Try alternative location for older/newer vLLM versions
        from vllm.model_executor.model_loader.loader import process_weights_after_loading
    except ImportError:
        # Define dummy function if not found
        def process_weights_after_loading(*args, **kwargs): pass
